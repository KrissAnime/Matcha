var users = [
    ...
    
    {
        ...
        "gender": "Female",
        "sexual_pref": "Both",
        "location_lat": -26.1438, 
        "location_long": 27.9952,
    ...
    
    {
        ...
        "gender": "Female",
        "sexual_pref": "Both",
        "location_lat": -26.137965, 
        "location_long": 28.027522,
    ...
    
    {
        ...
        "gender": "Female",
        "sexual_pref": "Female",
        "location_lat": -26.016892, 
        "location_long": 28.014390,
    ...
    
    {
        ...
        "gender": "Female",
        "sexual_pref": "Men",
        "location_lat": -29.484693, 
        "location_long": 31.238786,
    ...
    
    {
        ...
        "gender": "Male",
        "sexual_pref": "Male",
        "location_lat": -27.642901, 
        "location_long": 27.231298,
    ...
    
    {
        ...
        "gender": "Female",
        "sexual_pref": "Male",
        "location_lat": -33.889319, 
        "location_long": 18.504452,
    ...
    },
    {
        ...
        "gender": "Male",
        "sexual_pref": "Both",
        "location_lat": -33.907289, 
        "location_long": 18.550811,
...
con.connect(function(err) {
    ...
    con.query(sql, function (err, result) {
        if (err){
            ...
            sql += " `message` VARCHAR(1000), `time_log` DATETIME DEFAULT CURRENT_TIMESTAMP, `logged` INT(1) DEFAULT '0') ENGINE = InnoDB;";
            con.query(sql, function (err, result) {
                if (err){
                    console.log(err);
                }
            ...
            for (const item of users){
                ...
                var location_lat = item.location_lat;
                var location_long = item.location_long;
                var age = item.age;
                ...
                sql +=  "`sexual_pref`, `location_lat`, `location_long`, `bio`, `interests`)";
                sql += " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                con.query(sql, [unique_key, profile, first_name, last_name, user_name, fame_rating, age, gender, sexual_pref, location_lat, location_long, bio, interests], function (err, result) {
                    if (err){
                        console.log(err);
                    }
                    else{
